...
- The `Disable Default FnKey - physalis_deffnkey.sh` is based in [this question](https://forums.linuxmint.com/viewtopic.php?t=368164) in Linux Mint forum for ASUS laptops.
---
